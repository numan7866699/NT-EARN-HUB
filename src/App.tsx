          ...
          <motion.div layout className="bg-[#111111] p-6 rounded-sm border border-white/10 shadow-xl">
            <form onSubmit={handleAuthSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input type="email" placeholder="e.g., user@ntglobalhub.com" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full bg-[#0A0A0A] p-4 rounded-xl border border-white/10 focus:border-pink-500 focus:ring-1 focus:ring-pink-500 outline-none text-xs text-white transition-all"/>
              </div>
